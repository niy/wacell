        ...
        $fields['general'] = 
                array(
                        ...
                        array(
                            ...
                            'desc' => sprintf(__( '<br>Your current login url: %s <a title="New WP Login" href="%s">[Bookmark me!]</a><br>Need to change login URL to something like /login? Try <a href="http://wordpress.org/extend/plugins/theme-my-login/">Theme My Login</a>', self::slug ), '<b>/wp-login.php?'.self::slug.'='.$this->opt('admin_key').'</b>', site_url('wp-login.php?'.self::slug.'='.$this->opt('admin_key')) ),
                            'type' => 'text',
                            'default' => '1234',
