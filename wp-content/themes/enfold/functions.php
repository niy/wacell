...
$avia_config['slectableImgSize'] = array(
	'square' 	=> __('مربع','avia_framework'),
	'featured'  => __('شاخص','avia_framework'),
	'portfolio' => __('عکس محصول','avia_framework'),
	'gallery' 	=> __('گالری','avia_framework'),
...
function no_update_notification() {	remove_action('admin_notices', 'update_nag', 3);}
